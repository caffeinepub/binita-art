...
import type { ExternalBlob as _ExternalBlob, Painting as _Painting, PaintingInfo as _PaintingInfo, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addPainting(arg0: PaintingInfo): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addPainting(await to_candid_PaintingInfo_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPainting(arg0: bigint): Promise<Painting> {
        if (this.processError) {
            try {
                const result = await this.actor.getPainting(arg0);
                return from_candid_Painting_n12(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async updatePainting(arg0: bigint, arg1: PaintingInfo): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePainting(arg0, await to_candid_PaintingInfo_n8(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Painting_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Painting): Promise<Painting> {
...
async function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Painting>): Promise<Array<Painting>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Painting_n12(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_PaintingInfo_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PaintingInfo): Promise<_PaintingInfo> {
